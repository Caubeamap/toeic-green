...
export const metadata: Metadata = {
  ...
  description:
    "Đăng nhập hoặc tạo tài khoản TOEIC Green để luyện thi TOEIC, theo dõi tiến bộ và cá nhân hoá lộ trình học tập."
};

/* ─────────────────────── Benefit chips ─────────────────────── */

const benefits = [
  { icon: BookOpen, text: "Truy cập 16+ đề thi ETS" },
  { icon: CheckCircle2, text: "Lưu kết quả & lịch sử" },
  { icon: ShieldCheck, text: "Lộ trình cá nhân hoá" }
];
            ...
            <div className="relative min-h-[620px] overflow-hidden rounded-[28px] border border-white/70 shadow-glass">
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 text-white">
                ...
                <p className="mt-4 max-w-md text-body-md text-white/88">
                  Lưu kết quả, theo dõi tiến bộ và tiếp tục luyện tập với lộ
                  trình phù hợp mục tiêu điểm số.
                </p>
              </div>
            </div>
          </div>
